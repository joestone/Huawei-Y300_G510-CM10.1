...
*/
    ...
    responseIccCardStatus(Parcel p) {
		...
		status.mGsmUmtsSubscriptionAppIndex = mGsmUmtsSubscriptionAppIndex;
		if (RILJ_LOGD) riljLog( "status.mGsmUmtsSubscriptionAppIndex " + mGsmUmtsSubscriptionAppIndex);
        int mCdmaSubscriptionAppIndex      = p.readInt();
		status.mCdmaSubscriptionAppIndex = mCdmaSubscriptionAppIndex;
		if (RILJ_LOGD) riljLog( "status.mCdmaSubscriptionAppIndex " + mCdmaSubscriptionAppIndex);
